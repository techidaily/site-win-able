---
title: "Mastering Treemaps in Excel: Techniques for Designing Tailored Data Diagrams"
date: 2024-08-28 17:53:59
updated: 2024-08-29 10:16:28
tags:
  - excel
categories:
  - tech
...
## Mastering Treemaps in Excel: Techniques for Designing Tailored Data Diagrams

### Quick Links

* [About Treemap Charts](https://windows11.techidaily.com/resolving-offline-errors-for-windows-11s-printer-port/)
* [How to Create a Treemap in Excel](https://fox-boxes.techidaily.com/2024-approved-understanding-av1-a-first-step-for-beginners/)
* [How to Customize a Treemap in Excel](https://facebook-record-videos.techidaily.com/updated-innovators-roundtable-for-youtube/)

 If you want to display hierarchical data in a compact visual, you can use a treemap chart. In Microsoft Excel, you can create and customize a treemap in just minutes. We'll show you how.

##  About Treemap Charts

 As mentioned, treemaps are intended to work with [hierarchical data](https://facebook-clips.techidaily.com/amp-up-the-sound-beat-downloads-on-fb-for-2024/), and this data has one-to-many relationships. Treemaps are a good tool for displaying things like best-selling products, location population, regional sales, and similar parent-child structured data.

Related: [How to Create an Organizational Chart in PowerPoint](https://facebook-clips.techidaily.com/amp-up-the-sound-beat-downloads-on-fb-for-2024/) 

 A treemap uses nested, colored rectangles which you can think of as the branches. Every item in the dataset is represented by a rectangle and the sizes of each correlate to the number data.
...
##  How to Create a Treemap in Excel
 ...
 As an example, we'll use a simple three-column dataset. We have our best-selling products which are categorized by type in the first column. The products within each category are in the second column. And finally, our units sold are in the third column.

![Treemap hierarchical data](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2021/08/TreemapData-ExcelTreemap.png) 

[Select the data](https://buynow-tips.techidaily.com/exploring-a-ravaged-world-on-motorcycle-in-days-gone-our-comprehhavis-review/) for the chart and head to the Insert tab. Click the "Hierarchy" drop-down arrow and select "Treemap."
...
![Treemap largest and smallest items](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2021/08/TreemapWithData-ExcelTreemap.png) 
...
![Drag to resize the chart in Excel](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2021/08/ResizeChart-ExcelTreemap.png) 
 ...
 Charts are super visuals that can help display your data in easy-to-read ways for your audience. So, you might also consider [creating a waterfall chart](https://youtube-docs.techidaily.com/approved-strategies-for-effective-youtube-playlist-distribution/) or [a Pareto chart](https://snapchat-videos.techidaily.com/new-in-2024-capturing-snapshots-transferring-from-snapchat-to-device-storage/) in Microsoft Excel.
