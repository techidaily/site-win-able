---
title: "Seamless Integration: Setting Up Microsoft Forms & Excel Online Auto-Sync"
date: 2024-08-28T05:23:54.044Z
updated: 2024-08-29T05:23:54.044Z
tags:
  - excel
categories:
  - tech
...
## Seamless Integration: Setting Up Microsoft Forms & Excel Online Auto-Sync

### Quick Links

* [Step 1: Create and Share Your Microsoft Form](https://facebook-video-share.techidaily.com/new-2024-approved-content-makers-compensation-breakdown-for-youtube-shorts/)
* [Step 2: View, Edit, and Use the Responses in Excel for the Web](https://facebook-clips.techidaily.com/the-ultimate-list-facebooks-top-10-vids-for-2024/)

 Are you collecting data through Microsoft Forms and want to review and analyze the results in real time? Excel for the web allows you to see and manipulate new entries as they come in.

 Previously, when you designed a form on Microsoft Forms, if you wanted to export your data to Microsoft Excel to crunch the numbers, you would have to download the results into an Excel 365 app workbook.

 This meant that each time you received a new submission on your form, you would either have to merge your Excel sheets or download the latest version and delete old copies, which can be a tedious and cumbersome task. This can still be useful if you've closed the form and are certain that you'll receive no more entries, as some functions work better in Excel's desktop app than in its online counterpart.
...
![Image shows an example Microsoft Form being created.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/03/creating-a-form.png) 
 ...
 When you have finished creating your form, confirm that you're happy with the options available for each answer and make sure you've toggled the "Required" button for all mandatory questions. This is a crucial step to ensure that you can fully analyze the data for the questions that really matter when you review the results in Excel for the web.

![A Microsoft Form in construction, with the 'Required' button toggled to make that particular question a mandatory question.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/03/mandatory-questions.png) 

 Finally, click "Collect Responses" and then choose how you will distribute your form, whether that be through a link, a direct Microsoft Forms invitation, a QR code, social media, or an embedded code on a website.
...
##  Step 2: View, Edit, and Use the Responses in Excel for the Web
 ...
 Click the "Responses" tab, and you will see the results in more detail in your browser window. However, to open the results in table form in Excel for the web, where you can manipulate your data, click "Open Results In Excel."
...
---
 ...
 Now that your data is viewable in an Excel for the web worksheet, you can share the results by clicking "Share" in the top-right corner of your window. And, while you're there, why not also try out some [other features that have been added to Excel for the web](https://fox-access.techidaily.com/updated-2024-approved-live-link-legends-favoring-the-framework-software-or-fabrication-hardware/)?
